from PyQt5.QtWidgets import QApplication, QDialog, QPushButton, QHBoxLayout, QGroupBox, QVBoxLayout, QGridLayout, QLabel
import sys
...
class Window(QDialog):
    ...
    def InitWindow(self):
        ...
        pixmap = QPixmap("Glados.jpg")
        labelImage.setPixmap(pixmap)
        vbox.addWidget(labelImage)
        label = QLabel("You Must Choose Your Fate!")
        label.setFont(QtGui.QFont("Comic Sans", 20))
